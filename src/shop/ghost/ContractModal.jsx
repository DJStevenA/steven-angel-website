    ...
    return (
      <div style={backdropStyle}>
        <div style={{ ...modalStyle(CYAN), textAlign: "center", padding: isMobile ? "40px 24px" : "56px 48px" }}>
          ...
          <div style={{ fontFamily: "'Barlow Condensed', 'Barlow Condensed Fallback', sans-serif", fontWeight: 900, fontSize: isMobile ? 32 : 44, textTransform: "uppercase", letterSpacing: "0.04em", color: "#fff", margin: "12px 0 16px", lineHeight: 1.1 }}>
            It's Yours.
          </div>
          <div style={{ fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 14, color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: 28 }}>
          ...
          {downloadUrl && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              style={{ display: "inline-block", padding: "14px 32px", background: `linear-gradient(135deg, ${CYAN}, #00b8d4)`, color: "#000", fontFamily: "'Barlow Condensed', 'Barlow Condensed Fallback', sans-serif", fontWeight: 900, fontSize: 15, letterSpacing: "0.15em", textTransform: "uppercase", textDecoration: "none", borderRadius: 8, marginBottom: 16 }}
            >
              Download Now
            </a>
          )}
          <div>
            <button
              ...
              style={{ background: "transparent", border: "none", color: "rgba(255,255,255,0.5)", fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 12, cursor: "pointer", textDecoration: "underline" }}
            >
              Go to My Account
            </button>
          </div>
  ...
  return (
    <div onClick={backdropClick} style={backdropStyle}>
      <div style={{ ...modalStyle(CYAN), maxHeight: "90vh", overflowY: "auto" }}>
        ...
        <div style={{ fontFamily: "'Barlow Condensed', 'Barlow Condensed Fallback', sans-serif", fontWeight: 900, fontSize: isMobile ? 22 : 28, textTransform: "uppercase", letterSpacing: "0.04em", color: "#fff", marginBottom: 6, lineHeight: 1.2 }}>
          {track.name}
        </div>
        <div style={{ fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 12, color: CYAN, marginBottom: 20 }}>
        ...
        {!authLoading && !user && (
          <div>
            <div style={{ fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 13, color: "rgba(255,255,255,0.65)", lineHeight: 1.6, marginBottom: 20, padding: "14px 16px", border: "1px solid rgba(0,229,255,0.2)", borderRadius: 8, background: "rgba(0,229,255,0.04)" }}>
        ...
        {!authLoading && user && step === "contract" && (
          <div>
            ...
            <div style={{ padding: "14px 16px", background: "rgba(0,229,255,0.04)", border: "1px solid rgba(0,229,255,0.15)", borderRadius: 8, marginBottom: 18 }}>
              <div style={{ fontFamily: "'Barlow Condensed', 'Barlow Condensed Fallback', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: "0.25em", textTransform: "uppercase", color: CYAN, marginBottom: 10 }}>
                What You Receive
              </div>
              {[
                ...
                <div key={item} style={{ display: "flex", gap: 8, alignItems: "flex-start", fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 12, color: "rgba(255,255,255,0.75)", marginBottom: 6, lineHeight: 1.5 }}>
            ...
            {/* NDA notice */}
            <div style={{ padding: "12px 16px", background: "rgba(187,134,252,0.04)", border: "1px solid rgba(187,134,252,0.2)", borderRadius: 8, marginBottom: 18, fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 12, color: "rgba(255,255,255,0.65)", lineHeight: 1.6 }}>
            ...
            {/* Legal name */}
            <label style={{ display: "block", fontFamily: "'Barlow Condensed', 'Barlow Condensed Fallback', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,255,255,0.65)", marginBottom: 6 }}>
            ...
            <input
              ...
              style={{ width: "100%", padding: "12px 14px", background: "#06060f", border: "1px solid rgba(255,255,255,0.15)", borderRadius: 6, fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 14, color: "#fff", boxSizing: "border-box", marginBottom: 14 }}
            />
            ...
            <label style={{ display: "flex", gap: 10, alignItems: "flex-start", cursor: "pointer", marginBottom: 20 }}>
              ...
              />
              <span style={{ fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 12, color: "rgba(255,255,255,0.7)", lineHeight: 1.5 }}>
            ...
            {signingError && (
              <div style={{ marginBottom: 14, padding: "10px 14px", background: "rgba(255,80,80,0.08)", border: "1px solid rgba(255,80,80,0.4)", borderRadius: 6, fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 12, color: "#ff8080" }}>
                {signingError}
              </div>
            )}
        ...
        {!authLoading && user && step === "paypal" && (
          <div>
            <div style={{ fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 13, color: "rgba(255,255,255,0.6)", marginBottom: 14, textAlign: "center" }}>
            ...
            <div style={{ padding: "12px 16px", background: "rgba(0,0,0,0.4)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 8, marginBottom: 18, display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
              <span style={{ fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 13, color: "rgba(255,255,255,0.6)" }}>Total</span>
              <span style={{ fontFamily: "'Barlow Condensed', 'Barlow Condensed Fallback', sans-serif", fontWeight: 900, fontSize: 24, color: CYAN }}>€{track.price_eur}</span>
            </div>
            <div ref={paypalRef} />
            {paypalError && (
              <div style={{ marginTop: 12, padding: "10px 14px", background: "rgba(255,80,80,0.08)", border: "1px solid rgba(255,80,80,0.4)", borderRadius: 6, fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 12, color: "#ff8080" }}>
                {paypalError}
              </div>
            )}
...
const btnPrimary = (accent) => ({
  ...
  color: "#000", fontFamily: "'Barlow Condensed', 'Barlow Condensed Fallback', sans-serif",
