        ...
        <div style={{ width: "100%", maxWidth: 440, background: BG_ALT, border: "1px solid #141420", borderTop: `2px solid ${CYAN}`, borderRadius: 12, padding: isMobile ? "32px 24px" : "40px 36px", boxShadow: "0 30px 60px rgba(0,0,0,0.5)" }}>
          ...
          {sent ? (
            <div style={{ marginTop: 24, textAlign: "center" }}>
              <p style={{ fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 14, color: "rgba(255,255,255,0.85)", lineHeight: 1.6, marginBottom: 20 }}>
                If an account exists for <strong style={{ color: CYAN }}>{email}</strong>, you'll get a password reset email within a minute.
              </p>
              <p style={{ fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 12, color: "rgba(255,255,255,0.55)", lineHeight: 1.6, marginBottom: 24 }}>
                Check your spam folder if you don't see it. The link is valid for 1 hour.
              </p>
              <Link to="/shop/login" style={{ color: CYAN, textDecoration: "none", fontFamily: "'Barlow Condensed', 'Barlow Condensed Fallback', sans-serif", fontWeight: 700, fontSize: 13, letterSpacing: "0.2em", textTransform: "uppercase" }}>
                Back to Sign In
              </Link>
            </div>
          ) : (
            <>
              ...
              <form onSubmit={handleSubmit}>
                ...
                />
                {error && (
                  <div style={{ fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 12, color: "#ff6b6b", marginBottom: 12, padding: "8px 12px", background: "rgba(255,107,107,0.08)", border: "1px solid rgba(255,107,107,0.3)", borderRadius: 4 }}>
                    {error}
                  </div>
                )}
                <button
              ...
              <div style={{ textAlign: "center", fontFamily: "'DM Sans', 'DM Sans Fallback', sans-serif", fontSize: 12, color: "rgba(255,255,255,0.5)", lineHeight: 1.7 }}>
                Remembered it?{" "}
