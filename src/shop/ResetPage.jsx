        ...
        <div style={{ width: "100%", maxWidth: 440, background: BG_ALT, border: "1px solid #141420", borderTop: `2px solid ${CYAN}`, borderRadius: 12, padding: isMobile ? "32px 24px" : "40px 36px", boxShadow: "0 30px 60px rgba(0,0,0,0.5)" }}>
          ...
          {success ? (
            <div style={{ marginTop: 24, textAlign: "center" }}>
              <p style={{ fontFamily: "DM Sans, sans-serif", fontSize: 14, color: "#4ade80", lineHeight: 1.6, marginBottom: 20 }}>
                ✓ Password updated.
              </p>
              <p style={{ fontFamily: "DM Sans, sans-serif", fontSize: 12, color: "rgba(255,255,255,0.55)" }}>
            ...
            <>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  required
                  minLength={MIN_PASSWORD_LENGTH}
                  style={{ width: "100%", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 6, padding: "12px 14px", fontFamily: "DM Sans, sans-serif", fontSize: 14, color: "#fff", marginBottom: 10, outline: "none", boxSizing: "border-box" }}
                  onFocus={(e) => (e.currentTarget.style.borderColor = CYAN)}
                  onBlur={(e) => (e.currentTarget.style.borderColor = "rgba(255,255,255,0.12)")}
                />
                {error && (
                  <div style={{ fontFamily: "DM Sans, sans-serif", fontSize: 12, color: "#ff6b6b", marginTop: 8, marginBottom: 12, padding: "8px 12px", background: "rgba(255,107,107,0.08)", border: "1px solid rgba(255,107,107,0.3)", borderRadius: 4 }}>
                    {error}
                  </div>
                )}
                <button
              ...
              <div style={{ textAlign: "center", fontFamily: "DM Sans, sans-serif", fontSize: 12, color: "rgba(255,255,255,0.5)" }}>
