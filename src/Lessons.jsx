      ...
      >
        ...
        <button
          ...
          style={{
            ...
            color: "rgba(255,255,255,0.62)", fontSize: 22, lineHeight: 1,
            padding: "4px 8px",
                  ...
                  {rows.map((row, idx) => (
                    <Fragment key={idx}>
                      <div style={{ background: "#04040f", padding: cellPad, borderBottom: idx < rows.length - 1 ? "1px solid #141420" : "none", display: "flex", alignItems: "flex-start", gap: 8 }}>
                        <span style={{ color: "#FF5C5C", fontWeight: 700, marginTop: 1, flexShrink: 0 }}>&#10007;</span>
              ...
              {[
                ...
                >
                  <div style={{ textAlign: "left" }}>
                    ...
                    <div style={{ ...body, fontSize: 12, color: "rgba(255,255,255,0.62)", marginTop: 2 }}>{detail}</div>
                  </div>
                  <div style={{ textAlign: "right" }}>
                    ...
                    <div style={{ fontFamily: "'Barlow Condensed', 'Barlow Condensed Fallback', sans-serif", fontWeight: 700, fontSize: 10, letterSpacing: "0.18em", textTransform: "uppercase", color: accent, opacity: 0.9, marginTop: 3 }}>
                      TO BOOK →
                    </div>
                  </div>
                </a>
